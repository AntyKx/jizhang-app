  ...
  return (
    <>
      ...
      <StaggerList className="flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="text-sm font-semibold text-muted-foreground">金流圖</h2>
          <CashFlowSankeyChart data={cashFlow} />
        </section>

        <section className="flex flex-col gap-2">
          <h2 className="text-sm font-semibold text-muted-foreground">累積支出</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="text-sm font-semibold text-muted-foreground">分類佔比趨勢（近 6 個月）</h2>
